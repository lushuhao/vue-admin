  ...
  <div class="main">
    ...
    <footer class="footer">
      <div>
        ...
        <el-button type="warning" @click="articleSetting(1)">股友圈文章置顶</el-button>
        <el-button type="success" @click="articleSetting(2)">首页文章显示推荐</el-button>
      </div>
      <!-- 分页 -->
    ...
    <!-- 文章置顶设置 -->
    <el-dialog :title="dialogArticleTitle" v-model="dialogArticle" size="tiny">
  ...
  export default {
    ...
    data () {
      return {
        ...
        dialogArticleTitle: '', // 文章设置弹出框的title
        // 推荐文章设置
        articleFormList: [
          {
            form: {
    ...
    methods: {
      ...
      articleSetting (type) {
        if (type === 1) {
          this.dialogArticleTitle = '首页推荐文章显示设置（允许为空）'
        } else {
          this.dialogArticleTitle = '股友圈文章显示设置（允许为空）'
        }
